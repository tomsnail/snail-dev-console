	...
	<div id="main">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/../static/ckfinder/ckfinder.html" target="mainFrame"><i class="icon-file"></i>&nbsp;  文件管理</a></li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2016-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.tomsnail.cn" target="_blank">tomsnail</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
