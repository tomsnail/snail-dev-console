										...
										children : [
												{
													...
													commit : function(B, C) {
														...
														if (B == d
															...
															var url = "http://pic.ehua.com.cn/";
															
															if(D.getValue().indexOf("jeesite")>0){
																url = url+D.getValue().split("jeesite")[1];
															}
															
															if(D.getValue().indexOf("ehua-manager")>0){
																url = url+D.getValue().split("ehua-manager")[1];
															}
															
															if(D.getValue().indexOf("pic.ehua.com.cn")>0){
																url = D.getValue();
															}
