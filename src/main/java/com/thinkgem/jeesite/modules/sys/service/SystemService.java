...
public class SystemService extends BaseService implements InitializingBean {
	...
	@SuppressWarnings("unchecked")
	public List<User> findDealer() {
		List<User> list = (List<User>)CacheUtils.get(UserUtils.USER_CACHE, UserUtils.USER_CACHE_LIST_BY_DEALER);
		if (list == null){
			User user = new User();
			Role role = new Role();
			role.setName("交易员");
			...
			CacheUtils.put(UserUtils.USER_CACHE, UserUtils.USER_CACHE_LIST_BY_DEALER, list);
		}
		return list;
	}
	...
	public void saveUser(User user) {
		CacheUtils.remove(UserUtils.USER_CACHE, UserUtils.USER_CACHE_LIST_BY_DEALER);
