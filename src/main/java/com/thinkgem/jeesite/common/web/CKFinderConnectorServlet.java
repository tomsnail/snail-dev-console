...
public class CKFinderConnectorServlet extends ConnectorServlet {
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		String path = prepareGetResponse(request, response, true);
		super.doPost(request, response);
		if(path!=null){
			String fullFileName = request.getAttribute("fullFileName")+"";
	...
	private String prepareGetResponse(final HttpServletRequest request,
...
//		}
		return request.getParameter("currentFolder");
	}
